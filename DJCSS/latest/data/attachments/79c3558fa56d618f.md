...
- Name: mct-form\mct-form-submission.spec.ts >> MCT Form Submission >> Arconic >> DJCSS-T140: Verify Unrestricted Upload of File for MyCompanyTodayForm - Arconic
...
- main:
  ...
  - list:
    - listitem:
      - text: arconic-malware.exe
      - button "Remove arconic-malware.exe":
        - img "Remove"
  - text: Any Comments?
