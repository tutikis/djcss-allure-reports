...
- Name: mct-form\mct-form-submission.spec.ts >> MCT Form Submission >> Constellium >> DJCSS-T145: Verify Unrestricted Upload of File for MyCompanyTodayForm - Constellium
...
- main:
  ...
  - list:
    - listitem:
      - text: constellium-malware.exe
      - button "Remove constellium-malware.exe":
        - img "Remove"
  - text: Any Comments?
