...
- Name: mct-form\mct-form-submission.spec.ts >> MCT Form Submission >> Otsuka >> DJCSS-T135: Verify Unrestricted Upload of File for MyCompanyTodayForm - Otsuka
...
- main:
  ...
  - list:
    - listitem:
      - text: otsuka-malware.exe
      - button "Remove otsuka-malware.exe":
        - img "Remove"
  - text: Any Comments?
