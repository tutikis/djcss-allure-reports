...
- Name: mct-form\mct-form-submission.spec.ts >> MCT Form Submission >> Constellium >> DJCSS-T141: Verify that the form submits successfully when all fields (Mandatory + Optional) are populated correctly - Constellium
...
- link "DJCSS Logo":
  ...
  - img "DJCSS Logo"
- main:
  - 'heading "Article Submission: Constellium Switzerland AG" [level=1]'
  ...
  - list:
    - listitem:
      - text: constellium-full-submit.txt
      - button "Remove constellium-full-submit.txt":
        - img "Remove"
  - text: Any Comments?
