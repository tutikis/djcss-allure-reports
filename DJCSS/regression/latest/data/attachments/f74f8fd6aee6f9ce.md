...
- Name: mct-form\mct-form-submission.spec.ts >> MCT Form Submission >> Prosegur >> DJCSS-T117: Verify that the form submits successfully when all fields (Mandatory + Optional) are populated correctly - Prosegur
...
- link "DJCSS Logo":
  ...
  - img "DJCSS Logo"
- main:
  - 'heading "Article Submission: Prosegur" [level=1]'
  ...
  - list:
    - listitem:
      - text: prosegur-full-submit.txt
      - button "Remove prosegur-full-submit.txt":
        - img "Remove"
  - text: Any Comments?
