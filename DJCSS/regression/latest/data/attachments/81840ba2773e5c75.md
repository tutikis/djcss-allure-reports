...
- Name: mct-form\mct-form-submission.spec.ts >> MCT Form Submission >> TRS >> DJCSS-T146: Verify that the form submits successfully when all fields (Mandatory + Optional) are populated correctly - TRS
- Location: tests\mct-form\mct-form-submission.spec.ts:265:9
...
- main:
  ...
  - list:
    - listitem:
      - text: trs-full-submit.txt
      - button "Remove trs-full-submit.txt":
        - img "Remove"
