...
- Name: mct-form\mct-form-submission.spec.ts >> MCT Form Submission >> Arconic >> DJCSS-T136: Verify that the form submits successfully when all fields (Mandatory + Optional) are populated correctly - Arconic
...
- main:
  ...
  - list:
    - listitem:
      - text: arconic-full-submit.txt
      - button "Remove arconic-full-submit.txt":
        - img "Remove"
  - text: Any Comments?
