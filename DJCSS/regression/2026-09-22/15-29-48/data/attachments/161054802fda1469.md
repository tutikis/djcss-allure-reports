...
- Name: mct-form\mct-form-submission.spec.ts >> MCT Form Submission >> TRS >> DJCSS-T148: Verify submission with only the mandatory fields filled, leaving all optional fields blank - TRS
- Location: tests\mct-form\mct-form-submission.spec.ts:305:9
...
- main:
  ...
  - list:
    - listitem:
      - text: trs-mandatory-only.txt
      - button "Remove trs-mandatory-only.txt":
        - img "Remove"
