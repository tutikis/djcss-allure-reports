...
- Name: mct-form\mct-form-submission.spec.ts >> MCT Form Submission >> Arconic >> DJCSS-T138: Verify submission with only the mandatory fields filled, leaving all optional fields blank - Arconic
...
- link "DJCSS Logo":
  ...
  - img "DJCSS Logo"
- main:
  - 'heading "Article Submission: Arconic Corporation" [level=1]'
