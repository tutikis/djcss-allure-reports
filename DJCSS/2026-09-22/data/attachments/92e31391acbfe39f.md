...
- Name: mct-form\mct-form-submission.spec.ts >> MCT Form Submission >> Otsuka >> DJCSS-T131: Verify that the form submits successfully when all fields (Mandatory + Optional) are populated correctly - Otsuka
...
- main:
  ...
  - list:
    - listitem:
      - text: otsuka-full-submit.txt
      - button "Remove otsuka-full-submit.txt":
        - img "Remove"
  - text: Any Comments?
